...
@implementation PopupCustomMenuCell
...
- (void)initUI
{
    ...
    _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(20, kCellH - 0.6, CURRENT_SCREEN_WIDTH, 0.6)];
...
- (void)layoutSubviews
{
    ...
    self.textLabel.frame = CGRectMake(kTextSpace + 10, 0, CGRectGetMinX(self.imageView.frame) - kTextSpace - 10, kCellH);
}
