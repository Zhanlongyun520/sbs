...
@property (atomic, strong, readwrite) dispatch_queue_t keepLiveQueue;
#else
@property (atomic, assign, readwrite) dispatch_queue_t keepLiveQueue;
#endif

//@property(nonatomic,readonly) dispatch_queue_t receiveAlarmQueue;
#if OS_OBJECT_USE_OBJC
@property (atomic, strong, readwrite) dispatch_queue_t receiveAlarmQueue;
#else
@property (atomic, assign, readwrite) dispatch_queue_t receiveAlarmQueue;
#endif
