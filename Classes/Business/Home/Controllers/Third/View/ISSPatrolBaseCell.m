...
#import "ISSPatrolBaseCell.h"
#import "NSString+Size.h"

@implementation ISSPatrolBaseCell
...
- (void)setModel:(ISSReportDetailModel *)model {
    ...
    _titleLabel.text = model.address;
    ...
    CGFloat titleWidth = [model.address getWidthOfFont:_titleLabel.font height:20];
    
    _statusLabel.text = model.statusDes;
...
- (void)clickButton:(UIButton *)button {
    if (self.showDetailBlock) {
        self.showDetailBlock(button.tag);
    }
}
