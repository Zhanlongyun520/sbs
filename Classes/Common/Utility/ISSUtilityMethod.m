...
@implementation ISSUtilityMethod
...
{
    //随机生成20位基础号
    NSMutableString *deviceId = [NSMutableString stringWithString:[ISSUtilityMethod randomStrWithType:1]];
    
    //首尾4位随机字符串
    NSString *headRandom = [ISSUtilityMethod randomStrWithType:2];
    NSString *tailRandom = [ISSUtilityMethod randomStrWithType:2];
    
    //随机4位key
    NSString * firstKey = [ISSUtilityMethod randomStrWithType:3];
    NSString * secondKey = nil;
    do {
        secondKey = [ISSUtilityMethod randomStrWithType:3];
