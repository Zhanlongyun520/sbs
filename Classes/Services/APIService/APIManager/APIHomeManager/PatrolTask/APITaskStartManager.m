...
#import "APITaskStartManager.h"

@implementation APITaskStartManager
...
{
    NSDictionary *dic = @{@"taskId": _taskId, @"taskName": _taskName};
    return dic;
}
...
- (NSString *)methodName
{
    return @"patrolTask/updateTaskStart";
}
