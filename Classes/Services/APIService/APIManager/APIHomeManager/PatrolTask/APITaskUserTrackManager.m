...
#import "APITaskUserTrackManager.h"

@implementation APITaskUserTrackManager
...
{
    NSMutableDictionary *dic = @{@"taskId": _taskId, @"userId": _userId};
    return dic;
}
...
- (NSString *)methodName
{
    return @"userTrack/findByUserIdAndTaskId";
}
