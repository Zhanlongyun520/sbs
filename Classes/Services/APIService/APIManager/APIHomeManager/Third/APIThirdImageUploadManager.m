...
@implementation APIThirdImageUploadManager
...
//        [ISSGlobalVariable sharedInstance].isJsonRequest = YES;
        [ISSGlobalVariable sharedInstance].isMultipartContent = YES;
    }
    return self;
}
