...
@implementation APIAddThirdManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    return @{
             ...
             @"developmentCompany":self.developmentCompany?:@"",
             @"constructionCompany":self.constructionCompany?:@"",
             @"supervisionCompany":self.supervisionCompany?:@"",
             @"patrolUser":self.patrolUser,
             @"patrolDateStart":self.patrolDateStart,
             @"patrolDateEnd":self.patrolDateEnd,
             @"name":self.name,
             @"content":self.content,
             @"isVisit":self.isVisit?:@"",
