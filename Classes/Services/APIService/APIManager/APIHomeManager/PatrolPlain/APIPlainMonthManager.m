...
#import "APIPlainMonthManager.h"
#import "ISSLoginUserModel.h"

@implementation APIPlainMonthManager
...
- (NSDictionary *)paramsForApi:(APIBaseManager *)manager
{
    NSDictionary *dic = @{@"userId": _userId,
                          @"planId": _planId ? : @"",
                          @"taskTimeStart": [NSString stringWithFormat:@"%@ 00:00:00", _taskTimeStart],
                          @"taskTimeEnd": [NSString stringWithFormat:@"%@ 23:59:59", _taskTimeEnd],
                          @"page": @(999),
                          @"TASKTYPE": @"0"};
    return dic;
}
